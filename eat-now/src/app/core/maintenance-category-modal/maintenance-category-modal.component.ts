...
@Component({
  selector: 'app-maintenance-category-modal',
  templateUrl: './maintenance-category-modal.component.html',
  styleUrls: ['./maintenance-category-modal.component.scss']
})
export class MaintenanceCategoryModalComponent implements OnInit {

  tempCategorySets: CategorySet[] = [{ name: '', description: '' }]; // Start with one empty set

  constructor(
    public dialogRef: MatDialogRef<MaintenanceCategoryModalComponent>,
